  ...
  window.__BRAND__ = {
    ...
    cheryModelos: {
      "m7": {
        ...
        colores: [
          { nombre: "Blanco perlado", hex: "#F1F1EE" },
      ...
      "tiggo-2-pro": {
        ...
        categoria: "SUV",
        hero: "assets/img/chery/tiggo-2-pro.webp",
        ...
        colores: [
          ...
          { nombre: "Ash Gray", hex: "#9EA3A6" },
          { nombre: "Nasdaq Silver", hex: "#C2C6C9" },
          { nombre: "Negro", hex: "#0F1113" }
        ],
        versiones: ["Pro"]
      },
      "tiggo-4-csh": {
        ...
        categoria: "SUV",
        hero: "assets/img/chery/tiggo-4-csh.webp",
        ...
        colores: [
          { nombre: "Rojo", hex: "#C62828" },
          { nombre: "Blanco", hex: "#F1F1EE" },
          { nombre: "Gris", hex: "#B8BCC0" },
          { nombre: "Gris oscuro", hex: "#4A4E52" },
          { nombre: "Negro", hex: "#0F1113" }
        ],
      ...
      "tiggo-7-csh": {
        ...
        categoria: "SUV",
        hero: "assets/img/chery/tiggo-7-csh.webp",
      ...
      "himla": {
        ...
        subtitulo: "Pick up",
        categoria: "Pick Up",
        hero: "assets/img/chery/himla.webp",
