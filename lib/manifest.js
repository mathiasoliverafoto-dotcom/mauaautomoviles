...
(function () {
  ...
  // Número principal = Sucursal Florencio Sánchez (Mauá central).
  var PHONE_INTL = "59891940049"; // Uruguay +598, sin el 0 inicial

  window.__BRAND__ = {
    name: "Mauá Automóviles",
    tagline: "Representante oficial Chery en Cerro Largo",
    phoneDisplay: "091 940 049",
    tel: "+59891940049",
    whatsapp: "https://wa.me/" + PHONE_INTL,
    instagram: "https://www.instagram.com/maua_automoviles/",

    /* Locales con dirección, mapa y teléfono/WhatsApp propios.
       "waIntl" es el número en formato internacional para armar links
       wa.me — se usa cuando alguien consulta por un vehículo publicado
       en esa sucursal. */
    locales: [
      {
        id: "central",
